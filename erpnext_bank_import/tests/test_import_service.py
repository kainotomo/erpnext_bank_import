...
class TestImportTransactions:
	...
	def test_import_all_duplicates_skipped(self, mock_all):
		...
		svc_frappe.get_all.return_value = [
			"mock-txn-1-1", "mock-txn-1-2", "mock-txn-1-3", "mock-txn-1-4",
			"mock-txn-1-5", "mock-txn-1-6", "mock-txn-1-7", "mock-txn-1-8",
			"mock-txn-1-9", "mock-txn-1-10",
			"mock-txn-2-1", "mock-txn-2-2", "mock-txn-2-3", "mock-txn-2-4",
			"mock-txn-2-5", "mock-txn-2-6", "mock-txn-2-7", "mock-txn-2-8",
			"mock-txn-2-9", "mock-txn-2-10",
			"mock-txn-3-1", "mock-txn-3-2", "mock-txn-3-3", "mock-txn-3-4",
			"mock-txn-3-5", "mock-txn-3-6", "mock-txn-3-7", "mock-txn-3-8",
			"mock-txn-3-9", "mock-txn-3-10",
		]
		result = import_transactions("_Test Connector")
		r = result["results"][0]
		assert r["created"] == 0
